...
public class A1_StandardActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void init() {
        ...
        //This activityCount from my calculation.
    ...
    private void initView() {
        ...
        ((TextView) findViewById(R.id.tv_title)).setText(getString(R.string.mode1));
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_print_stack_activity: {
                //This activityCount(numActivities) from stack calculation.
