...
public class D_SingleInstanceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        ((TextView) findViewById(R.id.tv_title)).setText(getString(R.string.modeD));
    }
